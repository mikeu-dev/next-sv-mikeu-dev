...
<div class="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-12 selection:bg-primary selection:text-primary-foreground">
	...
	<div class="pointer-events-none absolute inset-0 -z-10">
		<div class="absolute top-0 right-0 h-[60vh] w-[60vw] bg-primary/5" style="clip-path: polygon(100% 0, 0 0, 100% 100%);"></div>
		<div class="absolute bottom-0 left-0 h-[40vh] w-[40vw] bg-foreground/[0.02]" style="clip-path: polygon(0 0, 0 100%, 100% 100%);"></div>
	</div>
	...
	>
		...
		<div class="absolute -bottom-1 -right-1 size-4 border-b-4 border-r-4 border-primary"></div>
		...
		<div class="mb-8 flex items-center justify-between border-b-2 border-foreground/10 pb-4">
			...
			<div class="font-mono text-[8px] font-black text-muted-foreground uppercase tracking-tighter">
				PROTO_V5.0 // ID_AUTH
			</div>
		</div>

		<div class="mb-10">
			<h1 class="font-poppins text-4xl font-black tracking-tighter uppercase leading-none">
				System<span class="text-primary">.</span>Login
			</h1>
			<p class="mt-2 font-mono text-[10px] font-black text-muted-foreground uppercase tracking-widest">
		...
		<form onsubmit={handleSubmit} class="grid gap-6">
			...
			<div class="login-stagger group relative grid gap-2">
				<label for="email" class="flex items-center gap-2 font-mono text-[10px] font-black uppercase tracking-widest text-muted-foreground transition-colors group-focus-within:text-primary">
				...
				<input 
					...
					required 
					bind:value={email}
					class="h-12 border-2 border-foreground bg-transparent px-4 font-mono text-xs font-black uppercase tracking-wider outline-none transition-all focus:border-primary focus:bg-primary/5 focus:ring-4 focus:ring-primary/10"
				/>
			</div>

			<!-- Input Password -->
			<div class="login-stagger group relative grid gap-2">
				<label for="password" class="flex items-center gap-2 font-mono text-[10px] font-black uppercase tracking-widest text-muted-foreground transition-colors group-focus-within:text-primary">
			...
			<button 
				type="submit" 
				disabled={loading}
				class="login-stagger group relative mt-4 h-14 w-full bg-primary font-poppins text-sm font-black text-primary-foreground uppercase tracking-tighter transition-all hover:bg-foreground hover:text-background active:scale-[0.98] disabled:opacity-50"
			...
			>
				...
				<!-- Decorative Glow -->
				<div class="absolute inset-0 -z-10 bg-primary opacity-0 blur-xl transition-opacity group-hover:opacity-20"></div>
			</button>
		</form>

		<!-- Footer Metadata -->
		<div class="mt-12 flex items-center gap-4 font-mono text-[8px] font-black text-muted-foreground uppercase tracking-[0.3em]">
