...
>
  ...
  <div class="flex grow flex-col p-6">
    ...
    <p class="mb-4 text-muted-foreground relative max-h-16 overflow-hidden transition-all duration-300 group-hover:max-h-96">
      {project.description}
      <!-- gradient overlay untuk efek fade -->
      <span class="absolute bottom-0 left-0 w-full h-6 bg-gradient-to-t from-card to-transparent group-hover:hidden"></span>
    </p>
