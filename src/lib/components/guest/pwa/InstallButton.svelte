...
{#if pwaState.isInstallable}
	<div class={cn('relative inline-flex', className)} transition:fade>
		...
		<Button
			...
			class="group flex items-center gap-2 border-teal-600/50 hover:bg-teal-600/10 hover:text-teal-600 dark:border-teal-400/50 dark:hover:bg-teal-400/10 dark:hover:text-teal-400"
		>
