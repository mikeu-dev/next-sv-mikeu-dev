...
<div class="relative mx-auto max-w-[450px]">
	...
	>
		<!-- Digital Mesh Grid (High Visibility) -->
		<div class="pointer-events-none absolute inset-0 opacity-[0.25]" 
			style="background-image: linear-gradient(to right, #444 1px, transparent 1px), linear-gradient(to bottom, #444 1px, transparent 1px); background-size: 45px 45px;"></div>
		
		<!-- Radar Circle Accents -->
		<div class="pointer-events-none absolute inset-0 flex items-center justify-center opacity-[0.15]">
			<div class="size-[200px] rounded-full border-2 border-white/40"></div>
			<div class="absolute size-[400px] rounded-full border-2 border-white/20"></div>
		</div>

		<!-- Inner Vignette for 3D Depth -->
		<div class="pointer-events-none absolute inset-0 z-10 shadow-[inset_0_0_150px_rgba(0,0,0,1)]"></div>
		
		<!-- CRT / Scanline Overlays (Restored & High Visibility) -->
		<div class="pointer-events-none absolute inset-0 opacity-[0.1] z-30" 
			style="background-image: linear-gradient(rgba(18,16,16,0) 50%, rgba(0,0,0,0.3) 50%), linear-gradient(90deg, rgba(255,0,0,0.08), rgba(0,255,0,0.03), rgba(0,0,255,0.08)); background-size: 100% 4px, 3px 100%;"></div>
		
		<!-- Noise Texture Overlay -->
		<div class="pointer-events-none absolute inset-0 opacity-[0.1] z-20"
